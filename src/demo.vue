<template>
  <div class="tdesign-demo-block-column-large">
    ...
    <t-table
      ...
      :column-controller="{
        placement,
        fields: ['platform', 'type', 'default', 'needed', 'detail.position'],
    ...
    >
      <template #平台> 平台11 <t-button /> </template>
    </t-table>
...
const staticColumn = ['needed', 'detail.position'];
const displayColumns = ref(
  staticColumn.concat(['platform', 'type', 'default'])
);
